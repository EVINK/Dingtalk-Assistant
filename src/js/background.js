...
var Notify = (function () {
    ...
    Notify.sendChromeNotification = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!Notify.lastNotificationId) return [3, 2];
                        return [4, this.clearChromeNotification()];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2:
                        ...
                        return [2, new Promise(function (resolve) {
                                chrome.notifications.create(null, __assign({}, data), function (nid) {
    ...
    Notify.clearChromeNotification = function () {
        var _this = this;
        return new Promise(function (resolve) {
            chrome.notifications.clear(Notify.lastNotificationId, function (wasCleared) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    resolve(wasCleared);
                    return [2];
                });
